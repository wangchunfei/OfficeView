...
import com.wangchunfei.reader.office.hssf.formula.eval.AreaEvalBase;
import com.wangchunfei.reader.office.hssf.formula.eval.ValueEval;
import com.wangchunfei.reader.office.hssf.formula.ptg.AreaI;
...
final class LazyAreaEval extends AreaEvalBase {
	...
	public AreaEval offset(int relFirstRowIx, int relLastRowIx, int relFirstColIx, int relLastColIx) {
		AreaI area = new AreaI.OffsetArea(getFirstRow(), getFirstColumn(),
