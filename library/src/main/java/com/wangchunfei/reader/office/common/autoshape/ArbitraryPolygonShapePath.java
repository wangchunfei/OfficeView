 ...
 * 时间:               上午9:55:22
 */
package com.wangchunfei.reader.office.common.autoshape;
...
public class ArbitraryPolygonShapePath
{
    ...
    private static Path getArrowPath(ArbitraryPolygonShape arbitraryPolygonShape, Element pathElement, Rectangle rect, BackgroundAndFill fill, boolean border, PointF headerArrowTailCenter, PointF tailArrowTailCenter)
    {
        ...
        for(int i = 0; i < cnt; i++)
        {
        			...
        			&& e.getName().equals("moveTo"))
        	{
        		//header arrow
        		pathClosed = false;
        		headerArrowTailCenter = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getReferencedPosition(e.element("pt"), headerArrowTailCenter, arbitraryPolygonShape.getStartArrowType());
        	...
        	else if(tailArrowTailCenter != null && i == cnt - 1)
        	{
                ...
                {
        			tailArrowTailCenter = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getReferencedPosition(e.element("pt"), tailArrowTailCenter, arbitraryPolygonShape.getEndArrowType());
                ...
                else if(e.getName().equals("quadBezTo"))
                {
            		...
            		tailArrowTailCenter = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getReferencedPosition((Element)ptList.get(1), tailArrowTailCenter, arbitraryPolygonShape.getEndArrowType());
                ...
                else if(e.getName().equals("cubicBezTo"))
                {
                    ...
                    tailArrowTailCenter = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getReferencedPosition((Element)ptList.get(2), tailArrowTailCenter, arbitraryPolygonShape.getEndArrowType());
    ...
    public static ArrowPathAndTail getPathHeadArrowPath(Arrow arrow, int lineWidth, Element pathElement)
    {
        ...
        if(e.getName().equals("lnTo"))
        {
            ...
            path = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getDirectLineArrowPath(p1X, p1Y, p0X, p0Y, arrow, lineWidth);
        ...
        else if(e.getName().equals("quadBezTo"))
        {
            ...
            if(ptList.size() == 2)
            {
                ...
                path = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getQuadBezArrowPath(p1X, p1Y, ctrX1, ctrY1, p0X, p0Y, arrow, lineWidth);
            }
        ...
        else if(e.getName().equals("cubicBezTo"))
        {
            ...
            if(ptList.size() == 3)
            {
                ...
                path = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getCubicBezArrowPath(p1X, p1Y, ctrX2, ctrY2, ctrX1, ctrY1, p0X, p0Y, arrow, lineWidth);
            }
        }
    ...
    public static ArrowPathAndTail getPathTailArrowPath(Arrow arrow, int lineWidth, Element pathElement)
    {
        ...
        if(e.getName().equals("lnTo"))
        {
            ...
            arrowPathAndTail = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getDirectLineArrowPath(p0X, p0Y, p1X, p1Y, arrow, lineWidth);
        }
        else if(e.getName().equals("quadBezTo"))
        {
            List ptList = e.elements();
            if(ptList.size() == 2)
            {
                ...
                arrowPathAndTail = com.wangchunfei.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder.getQuadBezArrowPath(p0X, p0Y, ctrX1, ctrY1, p1X, p1Y, arrow, lineWidth);
            }
