...
package com.wangchunfei.reader.office.fc.hslf.blip;
...
public final class WMF extends Metafile
{
    ...
    public byte[] getData()
    {
        try
        {
            ...
            header.read(rawdata, PictureData.CHECKSUM_SIZE);
            is.skip(header.getSize() + PictureData.CHECKSUM_SIZE);
...
//            aldus.write(out);
    ...
    public void setData(byte[] data) throws IOException
    {
        ...
        byte[] checksum = PictureData.getChecksum(data);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        out.write(checksum);
        header.write(out);
