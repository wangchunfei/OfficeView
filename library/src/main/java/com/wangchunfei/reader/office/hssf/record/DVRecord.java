...
import com.wangchunfei.reader.office.hssf.formula.Formula;
...
import com.wangchunfei.reader.office.hssf.usermodel.HSSFDataValidation;
import com.wangchunfei.reader.office.fc.ss.util.CellRangeAddressList;
import com.wangchunfei.reader.office.fc.ss.util.HSSFCellRangeAddress;
import com.wangchunfei.reader.office.fc.util.BitField;
import com.wangchunfei.reader.office.fc.util.LittleEndianOutput;
import com.wangchunfei.reader.office.fc.util.StringUtil;
...
public final class DVRecord extends StandardRecord {
	...
	private static final com.wangchunfei.reader.office.hssf.record.common.UnicodeString NULL_TEXT_STRING = new com.wangchunfei.reader.office.hssf.record.common.UnicodeString("\0");

	/** Option flags */
	private int _option_flags;
	/** Title of the prompt box */
	private com.wangchunfei.reader.office.hssf.record.common.UnicodeString _promptTitle;
	/** Title of the error box */
	private com.wangchunfei.reader.office.hssf.record.common.UnicodeString _errorTitle;
	/** Text of the prompt box */
	private com.wangchunfei.reader.office.hssf.record.common.UnicodeString _promptText;
	/** Text of the error box */
	private com.wangchunfei.reader.office.hssf.record.common.UnicodeString _errorText;
	 ...
	 * @see com.wangchunfei.reader.office.fc.ss.usermodel.com.wangchunfei.reader.office.fc.ss.usermodel.com.wangchunfei.reader.office.fc.ss.usermodel.DataValidationConstraint.ValidationType
	 */
	 ...
	 * @see com.wangchunfei.reader.office.fc.ss.usermodel.com.wangchunfei.reader.office.fc.ss.usermodel.com.wangchunfei.reader.office.fc.ss.usermodel.DataValidation.ErrorStyle
	 */
	...
	private static String formatTextTitle(com.wangchunfei.reader.office.hssf.record.common.UnicodeString us) {
	 ...
	 */
	private static com.wangchunfei.reader.office.hssf.record.common.UnicodeString resolveTitleText(String str) {
		if (str == null || str.length() < 1) {
			return NULL_TEXT_STRING;
		}
		return new com.wangchunfei.reader.office.hssf.record.common.UnicodeString(str);
	}
	
	private static com.wangchunfei.reader.office.hssf.record.common.UnicodeString readUnicodeString(RecordInputStream in) {
		return new com.wangchunfei.reader.office.hssf.record.common.UnicodeString(in);
	}

	private static void serializeUnicodeString(com.wangchunfei.reader.office.hssf.record.common.UnicodeString us, LittleEndianOutput out) {
