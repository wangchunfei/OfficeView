...
final class SSTSerializer {
    ...
    private final IntMapper<com.wangchunfei.reader.office.hssf.record.common.UnicodeString> strings;
    ...
    public SSTSerializer(IntMapper<com.wangchunfei.reader.office.hssf.record.common.UnicodeString> strings, int numStrings, int numUniqueStrings )
    {
    ...
    public void serialize(ContinuableRecordOutput out) {
        ...
        for ( int k = 0; k < strings.size(); k++ )
        {
          ...
          com.wangchunfei.reader.office.hssf.record.common.UnicodeString s = getUnicodeString(k);
          s.serialize(out);
        }
    }


    private com.wangchunfei.reader.office.hssf.record.common.UnicodeString getUnicodeString(int index )
    {
        return getUnicodeString(strings, index);
    }

    private static com.wangchunfei.reader.office.hssf.record.common.UnicodeString getUnicodeString(IntMapper<UnicodeString> strings, int index )
    {
