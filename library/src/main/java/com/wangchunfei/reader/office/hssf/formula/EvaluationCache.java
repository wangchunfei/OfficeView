...
/**
 * Performance optimisation for {@link com.wangchunfei.reader.office.fc.ss.usermodel.com.wangchunfei.reader.office.fc.ss.usermodel.FormulaEvaluator}.
...
final class EvaluationCache {
	...
	private void updateAnyBlankReferencingFormulas(int bookIndex, int sheetIndex,
		...
		_formulaCellCache.applyOperation(new FormulaCellCache.IEntryOperation() {
