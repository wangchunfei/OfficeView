 ...
 * 时间:               下午4:23:51
 */
package com.wangchunfei.reader.office.fc.ppt;
...
import com.wangchunfei.reader.bean.DocSourceType;
import com.wangchunfei.reader.office.common.PaintKit;
import com.wangchunfei.reader.office.common.autoshape.ExtendPath;
import com.wangchunfei.reader.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.wangchunfei.reader.office.common.bg.BackgroundAndFill;
import com.wangchunfei.reader.office.common.bg.Gradient;
import com.wangchunfei.reader.office.common.bg.LinearGradientShader;
import com.wangchunfei.reader.office.common.bg.RadialGradientShader;
import com.wangchunfei.reader.office.common.bg.TileShader;
import com.wangchunfei.reader.office.common.hyperlink.Hyperlink;
import com.wangchunfei.reader.office.common.pictureefftect.PictureEffectInfoFactory;
import com.wangchunfei.reader.office.common.shape.AbstractShape;
import com.wangchunfei.reader.office.common.shape.ArbitraryPolygonShape;
import com.wangchunfei.reader.office.common.shape.Arrow;
import com.wangchunfei.reader.office.common.shape.AutoShape;
import com.wangchunfei.reader.office.common.shape.GroupShape;
import com.wangchunfei.reader.office.common.shape.IShape;
import com.wangchunfei.reader.office.common.shape.LineShape;
import com.wangchunfei.reader.office.common.shape.PictureShape;
import com.wangchunfei.reader.office.common.shape.ShapeTypes;
import com.wangchunfei.reader.office.common.shape.TableCell;
import com.wangchunfei.reader.office.common.shape.TableShape;
import com.wangchunfei.reader.office.common.shape.TextBox;
import com.wangchunfei.reader.office.constant.AutoShapeConstant;
import com.wangchunfei.reader.office.constant.EventConstant;
import com.wangchunfei.reader.office.constant.MainConstant;
import com.wangchunfei.reader.office.constant.wp.WPAttrConstant;
import com.wangchunfei.reader.office.constant.wp.WPModelConstant;
import com.wangchunfei.reader.office.fc.FCKit;
import com.wangchunfei.reader.office.fc.ShapeKit;
import com.wangchunfei.reader.office.fc.hslf.HSLFSlideShow;
import com.wangchunfei.reader.office.fc.hslf.model.Fill;
import com.wangchunfei.reader.office.fc.hslf.model.Freeform;
import com.wangchunfei.reader.office.fc.hslf.model.HeadersFooters;
import com.wangchunfei.reader.office.fc.hslf.model.Line;
import com.wangchunfei.reader.office.fc.hslf.model.MasterSheet;
import com.wangchunfei.reader.office.fc.hslf.model.Notes;
import com.wangchunfei.reader.office.fc.hslf.model.Picture;
import com.wangchunfei.reader.office.fc.hslf.model.Shape;
import com.wangchunfei.reader.office.fc.hslf.model.ShapeGroup;
import com.wangchunfei.reader.office.fc.hslf.model.Sheet;
import com.wangchunfei.reader.office.fc.hslf.model.SimpleShape;
import com.wangchunfei.reader.office.fc.hslf.model.Slide;
import com.wangchunfei.reader.office.fc.hslf.model.SlideMaster;
import com.wangchunfei.reader.office.fc.hslf.model.TextShape;
import com.wangchunfei.reader.office.fc.hslf.model.TitleMaster;
import com.wangchunfei.reader.office.fc.hslf.model.Table;
import com.wangchunfei.reader.office.fc.hslf.record.BinaryTagDataBlob;
import com.wangchunfei.reader.office.fc.hslf.record.ClientVisualElementContainer;
import com.wangchunfei.reader.office.fc.hslf.record.DocumentAtom;
import com.wangchunfei.reader.office.fc.hslf.record.OEPlaceholderAtom;
import com.wangchunfei.reader.office.fc.hslf.record.PositionDependentRecordContainer;
import com.wangchunfei.reader.office.fc.hslf.record.Record;
import com.wangchunfei.reader.office.fc.hslf.record.SlideAtom;
import com.wangchunfei.reader.office.fc.hslf.record.SlideProgBinaryTagContainer;
import com.wangchunfei.reader.office.fc.hslf.record.SlideProgTagsContainer;
import com.wangchunfei.reader.office.fc.hslf.record.SlideShowSlideInfoAtom;
import com.wangchunfei.reader.office.fc.hslf.record.TextHeaderAtom;
import com.wangchunfei.reader.office.fc.hslf.record.TextRulerAtom;
import com.wangchunfei.reader.office.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeColorBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeCommandBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeEffectBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeMotionBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeNodeAttributeContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeNodeContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeRotationBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeScaleBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeSetBehaviorContainer;
import com.wangchunfei.reader.office.fc.hslf.record.TimeVariant;
import com.wangchunfei.reader.office.fc.hslf.record.VisualShapeAtom;
import com.wangchunfei.reader.office.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.wangchunfei.reader.office.fc.hslf.usermodel.PictureData;
import com.wangchunfei.reader.office.fc.hslf.usermodel.RichTextRun;
import com.wangchunfei.reader.office.fc.hslf.usermodel.SlideShow;
import com.wangchunfei.reader.office.fc.ppt.bulletnumber.BulletNumberManage;
import com.wangchunfei.reader.office.java.awt.Dimension;
import com.wangchunfei.reader.office.java.awt.Rectangle;
import com.wangchunfei.reader.office.java.awt.Rectanglef;
import com.wangchunfei.reader.office.java.awt.geom.Rectangle2D;
import com.wangchunfei.reader.office.pg.animate.ShapeAnimation;
import com.wangchunfei.reader.office.pg.model.PGModel;
import com.wangchunfei.reader.office.pg.model.PGNotes;
import com.wangchunfei.reader.office.pg.model.PGSlide;
import com.wangchunfei.reader.office.simpletext.font.FontTypefaceManage;
import com.wangchunfei.reader.office.simpletext.model.AttrManage;
import com.wangchunfei.reader.office.simpletext.model.IAttributeSet;
import com.wangchunfei.reader.office.simpletext.model.LeafElement;
import com.wangchunfei.reader.office.simpletext.model.ParagraphElement;
import com.wangchunfei.reader.office.simpletext.model.SectionElement;
import com.wangchunfei.reader.office.ss.util.format.NumericFormatter;
import com.wangchunfei.reader.office.system.AbstractReader;
import com.wangchunfei.reader.office.system.BackReaderThread;
import com.wangchunfei.reader.office.system.IControl;
...
{   
    ...
    private com.wangchunfei.reader.office.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.wangchunfei.reader.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.wangchunfei.reader.office.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.wangchunfei.reader.office.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.wangchunfei.reader.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.wangchunfei.reader.office.java.awt.Color fillColor = fill.getForegroundColor();
            	com.wangchunfei.reader.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.wangchunfei.reader.office.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.wangchunfei.reader.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof Freeform
            || shape instanceof com.wangchunfei.reader.office.fc.hslf.model.AutoShape
            || shape instanceof com.wangchunfei.reader.office.fc.hslf.model.TextBox
            || shape instanceof Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.wangchunfei.reader.office.fc.hslf.model.AutoShape
                    || shape instanceof com.wangchunfei.reader.office.fc.hslf.model.TextBox)
            {
                // autoShape
    ...
    private void processTable(PGSlide pgSlide, Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.wangchunfei.reader.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.wangchunfei.reader.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.wangchunfei.reader.office.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.wangchunfei.reader.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.wangchunfei.reader.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
...
//      }
     ...
     * 
     */
    private int converterColor(com.wangchunfei.reader.office.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
