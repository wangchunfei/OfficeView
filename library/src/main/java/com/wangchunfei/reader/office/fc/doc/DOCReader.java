...
package com.wangchunfei.reader.office.fc.doc;
...
import com.wangchunfei.reader.office.common.bookmark.Bookmark;
import com.wangchunfei.reader.office.common.borders.Border;
import com.wangchunfei.reader.office.common.borders.Borders;
import com.wangchunfei.reader.office.common.borders.Line;
import com.wangchunfei.reader.office.common.bulletnumber.ListData;
import com.wangchunfei.reader.office.common.bulletnumber.ListLevel;
import com.wangchunfei.reader.office.common.hyperlink.Hyperlink;
import com.wangchunfei.reader.office.common.picture.Picture;
...
import com.wangchunfei.reader.office.common.shape.WPAbstractShape;
import com.wangchunfei.reader.office.common.shape.WPAutoShape;
import com.wangchunfei.reader.office.common.shape.WPGroupShape;
import com.wangchunfei.reader.office.common.shape.WPPictureShape;
...
import com.wangchunfei.reader.office.fc.ddf.EscherContainerRecord;
import com.wangchunfei.reader.office.fc.ddf.EscherOptRecord;
import com.wangchunfei.reader.office.fc.ddf.EscherProperties;
import com.wangchunfei.reader.office.fc.ddf.EscherSimpleProperty;
import com.wangchunfei.reader.office.fc.ddf.EscherTextboxRecord;
import com.wangchunfei.reader.office.fc.hwpf.HWPFDocument;
import com.wangchunfei.reader.office.fc.hwpf.model.FieldsDocumentPart;
import com.wangchunfei.reader.office.fc.hwpf.model.ListFormatOverride;
import com.wangchunfei.reader.office.fc.hwpf.model.ListTables;
import com.wangchunfei.reader.office.fc.hwpf.model.POIListData;
import com.wangchunfei.reader.office.fc.hwpf.model.POIListLevel;
import com.wangchunfei.reader.office.fc.hwpf.model.PicturesTable;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.Bookmarks;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.BorderCode;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.CharacterRun;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.Field;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.HWPFShape;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.HeaderStories;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.InlineWordArt;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.OfficeDrawing;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.OfficeDrawings;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.POIBookmark;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.Paragraph;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.PictureType;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.Range;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.Section;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.Table;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.TableCell;
import com.wangchunfei.reader.office.fc.hwpf.usermodel.TableRow;
import com.wangchunfei.reader.office.fc.util.LittleEndian;
import com.wangchunfei.reader.office.java.awt.Rectangle;
import com.wangchunfei.reader.office.java.util.Arrays;
...
import com.wangchunfei.reader.office.simpletext.model.IElement;
...
import com.wangchunfei.reader.office.simpletext.view.PageAttr;
import com.wangchunfei.reader.office.ss.util.ModelUtil;
import com.wangchunfei.reader.office.system.AbstractReader;
import com.wangchunfei.reader.office.system.IControl;
import com.wangchunfei.reader.office.wp.model.CellElement;
import com.wangchunfei.reader.office.wp.model.HFElement;
import com.wangchunfei.reader.office.wp.model.RowElement;
import com.wangchunfei.reader.office.wp.model.TableElement;
import com.wangchunfei.reader.office.wp.model.WPDocument;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.wangchunfei.reader.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.wangchunfei.reader.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.wangchunfei.reader.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.wangchunfei.reader.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
