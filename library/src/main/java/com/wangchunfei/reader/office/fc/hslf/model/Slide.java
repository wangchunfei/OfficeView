...
package com.wangchunfei.reader.office.fc.hslf.model;
...
import com.wangchunfei.reader.office.fc.hslf.record.ColorSchemeAtom;
import com.wangchunfei.reader.office.fc.hslf.record.Comment2000;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.wangchunfei.reader.office.fc.hslf.record.Slide slide, Notes notes, SlideListWithText.SlideAtomsSet atomSet,
                 ExtendedPresRuleContainer.ExtendedParaAtomsSet[] extendedAtomsSets, int slideIdentifier, int slideNumber)
    {
    ...
    */
    ...
    {
        super(new com.wangchunfei.reader.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.wangchunfei.reader.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.wangchunfei.reader.office.fc.hslf.record.Slide)getSheetContainer();
    }
    ...
    public void dispose()
    {
        ...
        if (_extendedAtomsSets != null)
        {
            for (ExtendedPresRuleContainer.ExtendedParaAtomsSet eps : _extendedAtomsSets)
            {
                eps.dispose();
            }
