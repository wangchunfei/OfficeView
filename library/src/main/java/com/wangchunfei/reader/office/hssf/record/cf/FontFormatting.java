...
package com.wangchunfei.reader.office.hssf.record.cf;
...
import com.wangchunfei.reader.office.hssf.usermodel.HSSFFontFormatting;
...
public final class FontFormatting
{
	 ...
	 * @see HSSFFontFormatting#SS_NONE
	 * @see HSSFFontFormatting#SS_SUPER
	 * @see HSSFFontFormatting#SS_SUB
	 */
	 ...
	 *
	 * @see HSSFFontFormatting#U_NONE
	 * @see HSSFFontFormatting#U_SINGLE
	 * @see HSSFFontFormatting#U_DOUBLE
	 * @see HSSFFontFormatting#U_SINGLE_ACCOUNTING
	 * @see HSSFFontFormatting#U_DOUBLE_ACCOUNTING
	 */
