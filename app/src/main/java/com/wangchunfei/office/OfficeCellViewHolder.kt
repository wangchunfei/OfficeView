...
class OfficeCellViewHolder : RecyclerView.ViewHolder,OnClickListener {
    ...
    fun bindData(data: OfficeInfo?) {
        ...
        if (typeIcon == -1) {
            ...
            if (file.exists()) {
                ...
                itemView.mIvType.load(com.wangchunfei.reader.R.drawable.all_doc_ic)
            }
        } else {
