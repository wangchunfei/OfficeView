...
object OfficeUtil {
    private val TAG = "OfficeUtil"
    fun getDocFile(context: Context): ArrayList<OfficeGroupInfo> {
        ...
        val docGroupList = ArrayList<OfficeGroupInfo>()
        val docList = ArrayList<OfficeInfo>()
        val excelList = ArrayList<OfficeInfo>()
        val pptList = ArrayList<OfficeInfo>()
        val pdfList = ArrayList<OfficeInfo>()
        val txtList = ArrayList<OfficeInfo>()
        val imageList = ArrayList<OfficeInfo>()
        ...
        docGroupList.add(OfficeGroupInfo("DOC & DOCX",docList))
        docGroupList.add(OfficeGroupInfo("XLS & XLSX",excelList))
        docGroupList.add(OfficeGroupInfo("PPT & PPTX",pptList))
        docGroupList.add(OfficeGroupInfo("PDF",pdfList))
        docGroupList.add(OfficeGroupInfo("TXT",txtList))
        docGroupList.add(OfficeGroupInfo("IMAGE",imageList))
